...
export default function App() {
  ...
  // ── Login Screen ──────────────────────────────────────────────
  if (!userId) return (
    <div style={{ display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", height:"100vh", background:"#0F0F14", fontFamily:"Georgia, serif", padding:24 }}>
      <div style={{ fontSize:56, marginBottom:16 }}>📅</div>
      <div style={{ fontSize:28, color:"#E8C97E", fontStyle:"italic", marginBottom:8 }}>Daily Events</div>
      <div style={{ fontSize:14, color:"#666", marginBottom:48, textAlign:"center" }}>Track your daily life. Sync across all devices.</div>
      <button onClick={handleGoogleSignIn} disabled={signingIn}
        style={{ display:"flex", alignItems:"center", gap:12, background:"#fff", color:"#333", border:"none", borderRadius:12, padding:"14px 28px", fontSize:16, fontWeight:"bold", cursor:signingIn?"wait":"pointer", boxShadow:"0 4px 20px rgba(0,0,0,0.3)" }}>
      ...
      <div style={{ fontSize:12, color:"#444", marginTop:24, textAlign:"center", maxWidth:280 }}>
        Your data syncs across all your devices when signed in with Google
      </div>
    </div>
  );
